...
export default function MonthlyBoardPage() {
  ...
  const [progressMap, setProgressMap] = useState<Record<string, {   progress: string | null; cycleDate: string; syncedAt: string; dataMonth?: string | null; source?: string | null; detail?: any[] | null }>>({});
  ...
  const load = useCallback(async () => {
    ...
    try {
      ...
      if (pr.success) {
        const map: Record<string, {   progress: string | null; cycleDate: string; syncedAt: string; dataMonth?: string | null; source?: string | null; detail?: any[] | null }> = {};
