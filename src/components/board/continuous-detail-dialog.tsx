...
function PaymentTermsDetail({ bill, info }: { bill: AutoDetailBill & { summary?: any; suppliers?: Record<string, { number: string; name: string; amt: number }[]>; monthlyTrend?: any[] }; info?: { name: string; src: string; how: string; when: string } | null }) {
